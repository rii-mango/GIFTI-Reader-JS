...
var xmlStr = fs.readFileSync('./tests/data/base64.surf.gii', "utf8");
var gii = null;

describe('GIFTI-Reader-JS', function () {
    describe('test base64.surf.gii', function () {
        ...
        it('isBase64Binary() should equals true', function () {
            assert.equal(true, gii.getPointsDataArray().isBase64Binary());
